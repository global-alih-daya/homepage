! function(e) {
    var o = function() {
        for (var e = arguments[0], n = [].slice.call(arguments, 1), i = 0; i < n.length; ++i) {
          var t = n[i];
          for (key in t) {
            var r = t[key];
            e[key] = "object" == typeof r ? o("object" == typeof e[key] ? e[key] : {}, r) : r
          }
        }
        return e
      },
    ...
    o(t.prototype, {
      ...
      recordingTime: function() {
        return this.isRecording() ? .001 * (Date.now() - this.startTime) : null
      },
