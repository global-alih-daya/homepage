<head>
    ...
    <!-- theme stylesheet-->
    <link rel="stylesheet" href="<?php echo base_url('assets/css/style.lightblue.css')?>" id="theme-stylesheet">
    ...
    <!-- Fontawesome Kit -->
    <script src="https://kit.fontawesome.com/5266ee2b11.js"></script>
    <!-- Flaticon stylesheet -->
    ...
    <script type="text/javascript">
        ...
        s1.async=true;
        s1.src='https://embed.tawk.to/5d0b295c36eab97211185197/default';
        s1.charset='UTF-8';
