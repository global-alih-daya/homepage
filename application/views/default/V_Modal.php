          ...
          <div class="col-md-12">
            <div class="row">
              ...
              <div class="col-md-8">
                ...
                <div class="row">
                  <strong>Panggilan Inbound </strong>
                  <p class="lead">Merupakan panggilan masuk yang dilakukan oleh pelanggan untuk
                    melakukan pengaduan, menanyakan informasi, melaporkan kejanggalan, atau meminta
                    bantuan.</p>
                </div>
                <div class="row">
          ...
          <div class="col-md-12">
            <div class="row">
              ...
              <div class="col-md-8">
                ...
                <div class="row">
                  <strong>Panggilan Outbound </strong>
                  <p class="lead">Merupakan panggilan keluar yang dibuat oleh agen untuk suatu usaha
                    penjualan atau layanan secara individual.</p>
                </div>
                <div class="row">
                  <a href="<?php base_url();?>registrasi" class="btn btn-outline-info btn-block">Daftar</a>
                </div>
