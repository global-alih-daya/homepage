...
<header class="nav-holder make-sticky">
        <div id="navbar" role="navigation" class="navbar navbar-expand-lg">
          <div class="container"><a href="<?php base_url() ?>" class="navbar-brand home"><img src="/assets/img/gad-small.png" width="110" height="60" alt="Universal logo" class="d-none d-md-inline-block"><img src="/assets/img/gad-small.png"  width="65" height="40" alt="Universal logo" class="d-inline-block d-md-none"><span class="sr-only">GAD </span></a>
              ...
              <li class="nav-item"><a href="<?php echo base_url() ?>#faq" class="js-scroll-trigger">FAQ <b class="caret"></b></a></li>
                ...
                <li class="nav-item dropdown menu-large"><a href="#" data-toggle="dropdown" class="dropdown-toggle text-danger">Gabung Sekarang!<b class="caret"></b></a>
                  <ul class="dropdown-menu megamenu">
                    <li>
                      <div class="row">
                        <div class="col-lg-3"><img src="/assets/img/callcenter1.png" alt="" class="img-fluid d-none d-lg-block"></div>
