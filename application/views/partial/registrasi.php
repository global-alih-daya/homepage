<!-- section Register -->
<section style="background: url(https://www.gad.co.id/assets/img/bg-slide2.jpg) center top no-repeat; background-size: cover;" class="bar no-mb bg-fixed relative-positioned">
