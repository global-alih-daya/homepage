...
<!-- section about -->
<section class="bg-white bar" id="about">
...
<!-- section service -->
<section style="background: url('https://www.gad.co.id/assets/img/cc06.jpg') center top no-repeat; background-size: cover;" class="bar padding-big text-md-center" id="service">
      ...
      <div id="accordion" role="tablist">
        <div class="card card-primary">
          <div id="headingOne" role="tab" class="card-header">
            <h5 class="mb-0 mt-0"><a data-toggle="collapse" href="#collapseOne" aria-expanded="true"
                aria-controls="collapseOne">1. What to do if I have still not received the order?</a></h5>
          </div>
        ...
        <div class="card card-primary">
          <div id="headingTwo" role="tab" class="card-header">
            <h5 class="mb-0 mt-0"><a data-toggle="collapse" href="#collapseTwo" aria-expanded="false"
                aria-controls="collapseTwo" class="collapsed">2. What are the postal rates?</a></h5>
          </div>
          <div id="collapseTwo" role="tabpanel" aria-labelledby="headingTwo" data-parent="#accordion" class="collapse">
            <div class="card-body">Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson
        ...
        <div class="card card-primary">
          <div id="headingThree" role="tab" class="card-header">
            <h5 class="mb-0 mt-0"><a data-toggle="collapse" href="#collapseThree" aria-expanded="false"
                aria-controls="collapseThree" class="collapsed"> 3. Do you send overseas?</a></h5>
          </div>
